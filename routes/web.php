...
Route::prefix('apps')->group(function() {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        //route sales index
        Route::get('/reports/sales', [\App\Http\Controllers\Apps\ReportController::class, 'index'])->middleware('permission:sales.index')->name('apps.sales.index');
        
        //route sales filter
        Route::get('/reports/sales/filter', [\App\Http\Controllers\Apps\ReportController::class, 'filter'])->name('apps.sales.filter');

        //route profits index
        Route::get('/reports/profits', [\App\Http\Controllers\Apps\ReportController::class, 'profit'])->middleware('permission:profits.index')->name('apps.profits.index');

        //route profits filter
        Route::get('/reports/profits/filter', [\App\Http\Controllers\Apps\ReportController::class, 'profit_filter'])->name('apps.profits.filter');
