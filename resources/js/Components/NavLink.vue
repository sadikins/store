...
const classes = computed(() => {
    return props.active
        ? "inline-flex items-center px-1 pt-1 border-b-2 border-primary text-sm font-medium leading-5 text-white focus:outline-none focus:border-accent-red transition"
