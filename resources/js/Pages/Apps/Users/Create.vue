            ...
            <form @submit.prevent="submit">
                ...
                <div class="mb-5">
                    ...
                    <div v-for="(role, index) in roles" :key="index">
                        <input type="checkbox" class="rounded h-5 w-5 my-3" v-model="form.roles" :value="role.name" :id="`check-${role.id}`"/>
                        <label class="text-white mb-3 ml-3" :for="`check-${role.id}`">{{ role.name }}</label>
                    </div>
